...
public class EscrituraVariosObjetos {
	public static void main(String[] args) {
		...
		try {
			// Cuando abrimos un archivo en modo true se abre en modo Append, es decir no se borra o se sobreescribe.
			file = new FileOutputStream("resources\\agenda.dat", true);
